                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="">
                        <div class="x_content">
                            ...
                            <form method="post" action="{{ route('students.update', $students->id) }}" id="demo-form"
                                ...
                                @if ($students->image_personal)
                                    <div class="field item form-group">
                                        <div class="col-md-3"></div>
                                        <div class="col-md-4">
                                            <img src="{{ url('public/uploads/students/individual/' . $students->image_personal) }}"
                                                width="120px" alt="">
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-3">
                                        <div class="col-md-6 col-sm-3">
                                            <img src="{{ url('public/uploads/students/citizenIdentification/' . $students->image_citizenIdentification_front) }}"
                                                width="120px" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-3">
                                            <img src="{{ url('public/uploads/students/citizenIdentification/' . $students->image_citizenIdentification_backside) }}"
                                                width="120px" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="">
                                            <input class="form-control" data-validate-length-range="6"
                                                ...
                                                value="{{ old('last_name') ?? $students->last_name }}" name="last_name"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-9 col-sm-6">
                                            <input class="form-control" data-validate-length-range="6"
                                                data-validate-words="2"
                                                value="{{ old('first_name') ?? $students->first_name }}" name="first_name"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="input-group date" id="datepicker">
                                            <input type="text" value="{{ old('birthday') ?? $students->birthday }}"
                                        ...
                                        <div id="gender" class="btn-group" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-primary ms-2" data-toggle-class="btn-primary"
                                                ...
                                                <input type="radio" name="gender" value="fe-male" class="join-btn"
                                                    {{ $students->gender == 'fe-male' ? 'checked' : '' }}>
                                                Female
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6">
                                        <input class="form-control"
                                            type="text"value="{{ old('phone') ?? $students->phone }}" id="phone"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6">
                                        <input class="form-control" type="text"
                                            value="{{ old('hometown') ?? $students->hometown }}" id="hometown"
