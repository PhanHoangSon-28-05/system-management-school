                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="">
                        <div class="x_content">
                            ...
                            <form method="post" action="{{ route('departments.update', $department->id) }}" id="demo-form"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6">
                                        ...
                                        <input class="form-control" type="text" data-validate-length-range="6"
                                            data-validate-words="2" value="{{ old('name') ?? $department->name }}"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6">
                                        ...
                                        <textarea class="form-control" type="text" data-validate-length-range="6" data-validate-words="2" name="description"
                                            id="description" placeholder="...." required="required">{{ old('description') ?? $department->description }}</textarea>
