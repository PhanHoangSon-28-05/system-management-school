                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="">
                        <div class="x_content">
                            ...
                            <form method="post" action="{{ route('subjects.store') }}" id="demo-form"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" data-validate-words="2"
                                            ...
                                            placeholder="name-subject" required="required" />
                                        @error('name')
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6">
                                        <input class="form-control" type="text" data-validate-length-range="6"
                                            data-validate-words="2" name="credit_hours" id="credit_hours"
                                            required="required">
                                        @error('description')
                                            <span class="text-danger">{{ $massage }}</span><br>
                                        @enderror
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-6">
                                        <input class="form-control" type="number" data-validate-length-range="6"
                                            data-validate-words="2" value="{{ old('name') }}"
