                        ...
                        <form method="post" action="{{ route('users.store') }}" id="demo-form" data-parsley-validate enctype="multipart/form-data">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" data-validate-length-range="6" data-validate-words="2" value="{{ old('fullname') }}" name="fullname" id="fullname" placeholder="Phan Hoàng Sơn" required="required" />
                                    @error('fullname')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check form-check-inline">
                                                        <input name="role_ids" class="form-check-input" type="radio" value="{{ $item->id }}" id="{{ $item->id }}">
